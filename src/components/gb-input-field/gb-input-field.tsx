      ...
      <div class={classes}>
        <div class="input-with-label">
          ...
          {this.inputType === 'icon_leading' && (
            <div class="input-wrapper">
                ...
                <div class="icon">
                  {this.iconSwap ? (
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                      <path d="M5.83342 7.08334L8.2851 8.53286C9.71443 9.37794 10.2857 9.37794 11.7151 8.53286L14.1668 7.08334M7.58243 2.94713C9.1995 2.9065 10.8007 2.9065 12.4177 2.94713C15.0415 3.01305 16.3534 3.04602 17.296 3.99221C18.2386 4.9384 18.2658 6.21571 18.3203 8.77032C18.3378 9.59172 18.3378 10.4083 18.3203 11.2297C18.2658 13.7843 18.2386 15.0616 17.296 16.0078C16.3533 16.954 15.0415 16.9869 12.4177 17.0529C10.8007 17.0935 9.19951 17.0935 7.58244 17.0529C4.95869 16.9869 3.64682 16.954 2.70421 16.0078C1.76161 15.0616 1.73437 13.7843 1.67989 11.2297C1.66237 10.4083 1.66237 9.59171 1.67989 8.77031C1.73436 6.21569 1.7616 4.93839 2.70421 3.9922C3.64682 3.046 4.95869 3.01304 7.58243 2.94713Z" stroke="#4B5565" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                  )}
                </div>  
              ...
              {this.showCloseButton && (
                  <gb-btn size="sm" hierarchy='tertiary_gray' icon='only' icon-leading-swap='cancel-button'></gb-btn>
              )}
            </div>
          )}
          ...
          {this.inputType === 'leading_text' && (
            <div class={`input-wrapper ${this.size}`}>
              <div class="add-on">
                <p>http://</p>
              </div>
              <div class="text-input">
          ...
          {this.inputType === 'tags' && (
            <div class="input-wrapper">
              <div class="content">
                ...
                <input class="text-md-regular"></input>
              </div>
              {this.showValidation && (
                <span></span>
              )}
          ...
          {this.inputType === 'trailing_button' && (
            <div class="input-wrapper">
              ...
              <div class="trailing-btn">
                <gb-btn size='md' hierarchy='tertiary_gray' icon='only' icon-leading-swap="copy"></gb-btn>
              </div>
            </div>
          )}
          ...
          {this.inputType === 'count' && (
            <div class={`input-wrapper ${this.size}`}>
              ...
              <div class="count-action">
                {this.showCloseButton && (
                  <gb-btn class="decrease-btn" size='md' hierarchy='tertiary_gray' icon='only'></gb-btn>
                )}
                <gb-btn class="increase-btn" size='md' hierarchy='tertiary_gray' icon='only'></gb-btn>
              </div>
            </div>
          )}
        </div>
