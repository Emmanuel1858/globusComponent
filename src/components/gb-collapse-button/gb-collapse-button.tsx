...
export class GbCollapseButton {
    ...
    render() {
        return [
            <div>
                <div 
                    class={`collapse_btn ${this.color}`} onClick={this.toggleIcon.bind(this)} 
                ...
                {this.isHovered && this.currentIconDirection === 'left' ? (
                    <gb-tooltip class="tooltip" arrow-position="left">
                        <p slot="main_text" class="text-xs-semi-bold">Collapse</p>
                    </gb-tooltip>
                    ) : this.isHovered && this.currentIconDirection === 'right' ? (
                        <gb-tooltip class="tooltip" arrow-position="left">
                            <p slot="main_text" class="text-xs-semi-bold">Expand</p>
                        </gb-tooltip>
                    ) : null}
            </div>
        ];
